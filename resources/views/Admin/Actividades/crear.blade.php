...
<div class="form-wrapper actividad-modal-wrapper">
  <div class="page-title">
    <i class="fas fa-plus-circle text-success" style="color:#28a745;"></i>
  ...
  <form action="{{ route('admin.actividades.almacenar') }}" method="POST">
    ...
    <div class="form-grid-2cols">
      ...
      <div class="form-group form-group-descripcion" style="grid-column: 1 / -1;">
        ...
        <textarea name="descripcion" id="descripcion" class="form-control actividad-descripcion-area" rows="4"></textarea>
      </div>
    </div>
