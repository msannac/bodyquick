<div class="form-wrapper actividad-modal-wrapper">
  ...
  <form action="<?php echo e(route('cliente.reservas.almacenar')); ?>" method="POST">
    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\bodyquick\resources\views/Cliente/Reservas/nueva.blade.php ENDPATH**/ ?>