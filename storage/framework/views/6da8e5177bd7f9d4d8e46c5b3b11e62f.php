...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
  <head>
    ...
    <title><?php echo e(config('app.name', 'Bodyquick')); ?> - <?php echo $__env->yieldContent('title'); ?></title>
...
header img {
  ...
  <body>
    ...
    <header>
      <div class="container d-flex justify-content-between align-items-center">
        <a href="<?php echo e(url('/')); ?>">
          <img src="<?php echo e(asset('images/bodyquick-logo-chico.png')); ?>" alt="Bodyquick Logo" style="height: 50px;">
        </a>
        <div class="d-flex align-items-center">
          <?php if(auth()->guard()->check()): ?>
            <span class="mr-3"><?php echo e(auth()->user()->name); ?></span>
            <!-- Enlace a edición de perfil -->
            <a href="#" class="btn abrirModal" data-url="<?php echo e(auth()->user()->is_admin ? route('admin.perfil.editar') : route('cliente.perfil.editar')); ?>">
            ...
            ?>
            <a href="#" class="btn btn-outline-success ml-2 position-relative abrirModal" data-url="<?php echo e(route('carrito.index')); ?>">
                <i class="fas fa-shopping-cart"></i>
                <span id="carrito-badge" class="badge badge-danger position-absolute<?php echo e($carritoCount > 0 ? '' : ' d-none'); ?>" style="top:0; right:0; font-size:0.8rem"><?php echo e($carritoCount > 0 ? $carritoCount : ''); ?></span>
            </a>
    ...
    <footer class="text-center" style="background-color: #000; color: #fff; padding: 20px 0;">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4">
            <p>
              <img src="<?php echo e(asset('images/corazon-logo-bodyquick.png')); ?>" alt="Corazón Bodyquick" style="height:20px; vertical-align:middle;">
              Bodyquick.
            </p>
            <p>
          ...
          <div class="col-md-4">
            ...
            <div class="d-flex flex-column align-items-center">
              <img src="<?php echo e(asset('images/imagen1.jpeg')); ?>" alt="Imagen 1" style="height:50px; margin: 5px 0;">
              <img src="<?php echo e(asset('images/imagen2.png')); ?>" alt="Imagen 2" style="height:50px; margin: 5px 0;">
              <img src="<?php echo e(asset('images/imagen3.png')); ?>" alt="Imagen 3" style="height:50px; margin: 5px 0;">
            </div>
          </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body text-center">
            <!-- Imagen del logo -->
            <img src="<?php echo e(asset('images/corazon-logo-bodyquick.png')); ?>" alt="Corazón Bodyquick" style="height: 50px; margin-bottom: 20px;">
    ...
    <script>
      window.BASE_URL_RESERVAS = "<?php echo e(url(request()->is('admin/*') ? '/admin/reservas' : '/cliente/reservas')); ?>";
    </script>
    ...
    $.ajaxSetup({
      headers: {
        ...
        $(document).on('click', '#btnMarket', function(e) {
          e.preventDefault();
          $.get("<?php echo e(route('cliente.productos.index')); ?>", function(data) {
            $('#modalAccion .modal-body').html(data);
            $('#modalAccion').modal('show');
          });
        });
        ...
        success: function(huecos) {
          if (Array.isArray(huecos) && huecoSelect) {
            ...
            huecos.forEach(function(hueco) {
              ...
              huecoSelect.innerHTML += `<option value="${hueco.id}">${texto}</option>`;
            });
  ...
  if (actividadInicial) {
    $.ajax({
      url: `${baseUrl}/dias-disponibles`,
      method: 'GET',
      data: { actividad_id: actividadInicial },
      headers: { 'X-CSRF-TOKEN': csrfToken || '' },
      success: function(dias) {
        if ($(fechaInput).data('datepicker')) {
          try { $(fechaInput).datepicker('destroy'); } catch(e){}
  ...
  console.log(`Evaluando fecha: ${ymd}, día semana: ${dayOfWeek}, en array: ${dias.includes(ymd)}`);
        ...
        if (fechaInicial) {
          ...
          $.ajax({
            url: `${baseUrl}/huecos-disponibles`,
            method: 'GET',
            data: { actividad_id: actividadInicial, fecha: fechaInicial },
            headers: { 'X-CSRF-TOKEN': csrfToken || '' },
            success: function(huecos) {
              huecoSelect.innerHTML = '<option value="">Seleccione un hueco</option>';
  ...
  if (!actividadInicial) {
    resetActividad();
        ...
        window.actualizarContadorCarrito = function() {
            ...
            $.get("<?php echo e(route('carrito.contador')); ?>", function(data) {
                if (data.count > 0) {
...
<?php /**PATH C:\xampp\htdocs\bodyquick\resources\views/layouts/app.blade.php ENDPATH**/ ?>