<div class="form-wrapper actividad-modal-wrapper">
  ...
  <form action="<?php echo e(route('cliente.reservas.update', $reserva)); ?>" method="POST">
    <?php echo csrf_field(); ?>
    ...
    <div class="form-grid-1col">
      <div class="form-group">
        ...
        <select name="actividad" id="actividad" class="form-control">
          ...
          <?php $__currentLoopData = $actividades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $actividad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($actividad->id); ?>" <?php echo e($reserva->cita->actividad_id == $actividad->id ? 'selected' : ''); ?>><?php echo e($actividad->nombre); ?></option>
      ...
      <div class="form-group">
        ...
        <div class="input-group date" id="datepicker-container" style="margin-bottom:0;">
          <input type="text" name="fecha" id="fecha" class="form-control" value="<?php echo e($reserva->cita->fecha); ?>" placeholder="Seleccione un día" style="height:28px; padding:3px 6px; font-size:0.97rem;" autocomplete="off">
      ...
      <div class="form-group">
        ...
        <select name="cita_id" id="hueco" class="form-control">
          ...
          <option value="<?php echo e($reserva->cita->id); ?>" selected><?php echo e($reserva->cita->hueco); ?></option>
        </select>
      </div>
    </div>
...
</style><?php /**PATH C:\xampp\htdocs\bodyquick\resources\views/Cliente/Reservas/edit.blade.php ENDPATH**/ ?>