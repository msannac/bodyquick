...
<?php $__env->startSection('title', 'Panel de Control - Listado de Citas'); ?>
    ...
    <div class="col-md-10">
      <div class="container mt-4 position-relative">
        ...
        <div class="d-flex align-items-center">
          ...
          <a href="<?php echo e(route('admin.citas.crear')); ?>" 
             class="btn btn-success ml-3 inline-button abrirModal"
             data-url="<?php echo e(route('admin.citas.crear')); ?>">
        ...
        <!-- Filtros -->
        <form action="<?php echo e(route('admin.citas.listar')); ?>" method="GET" id="filtrosForm" class="mb-4">
          <div class="row align-items-end">
            ...
            <div class="form-group col-sm-12 col-md-3">
              ...
              <div class="input-group">
                <input type="text" name="fecha" id="fecha" class="form-control" required value="<?php echo e(request('fecha', $fecha)); ?>">
            ...
            <div class="form-group col-sm-12 col-md-3">
              ...
              <select name="actividad_id" id="actividad_id" class="form-control">
                ...
                <?php $__currentLoopData = $actividades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $actividad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($actividad->id); ?>" <?php echo e(($actividad->id == request('actividad_id', $actividad_id)) ? 'selected' : ''); ?>>
            ...
            <div class="form-group col-sm-12 col-md-3">
              ...
              <div class="input-group">
                ...
                <input type="text" name="cliente" id="cliente" class="form-control" placeholder="Buscar cliente..." value="<?php echo e(request('cliente')); ?>">
              </div>
            </div>
          </div>
        </form>
                  ...
                  <tr data-index="<?php echo e($loopIndex); ?>">
                    ...
                    <td>
                      <div class="btn-group-acciones">
                        ...
                        <a href="<?php echo e(route('admin.citas.editar', $cita)); ?>" 
                           class="btn-custom-editar abrirModal" 
                           data-url="<?php echo e(route('admin.citas.editar', $cita)); ?>">
...
<?php echo $__env->make('Admin.Citas.crear_masiva', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bodyquick\resources\views/Admin/Citas/index.blade.php ENDPATH**/ ?>