...
<?php $__env->startSection('title','Panel de Control - Listado de Entrenadores'); ?>
      ...
      <div class="col-12 col-md-10">
        <div class="container mt-4 position-relative">
          <div class="d-flex align-items-center">
            ...
            <a href="<?php echo e(route('admin.entrenadores.crear')); ?>" 
               class="btn btn-success ml-3 inline-button abrirModal" 
               data-url="<?php echo e(route('admin.entrenadores.crear')); ?>">
              ...
              <div class="col-12 col-md-4 mb-4">
                <div class="card small-card">
                  <div class="circle-img-wrapper">
                    <?php if($entrenador->profile_photo_path): ?>
                      <img src="<?php echo e(asset('storage/' . $entrenador->profile_photo_path)); ?>" class="card-img-top" alt="<?php echo e($entrenador->nombre); ?>">
                    <?php else: ?>
                      <img src="<?php echo e(asset('images/default-user.png')); ?>" class="card-img-top" alt="<?php echo e($entrenador->nombre); ?>">
                    <?php endif; ?>
                  </div>
                  <div class="card-body text-center p-2">
                    <h6 class="card-title mb-1"><?php echo e($entrenador->nombre); ?> <?php echo e($entrenador->apellidos); ?></h6>
                    <p class="card-text mb-2"><?php echo e(ucfirst($entrenador->especialidad)); ?></p>
                    <div class="btn-group-acciones">
                      <a href="<?php echo e(route('admin.entrenadores.editar', $entrenador)); ?>" 
                         class="btn-custom-editar abrirModal" data-url="<?php echo e(route('admin.entrenadores.editar', $entrenador)); ?>">
                        <i class="fas fa-edit"></i>
                      </a>
                      <form method="POST" action="<?php echo e(route('admin.entrenadores.eliminar', $entrenador)); ?>" style="display:inline;">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bodyquick\resources\views/Admin/Entrenadores/index.blade.php ENDPATH**/ ?>